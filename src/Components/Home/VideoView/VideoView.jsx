            ...
            <div className='container mx-auto px-4 xl:px-20'>
                <div className='flex flex-col items-center justify-between gap-y-10 lg:gap-y-15 xl:gap-y-18 text-center md:mt-[-15rem] lg:mt-[-21rem] xl:mt-[-26rem]'>
                    <div className='flex flex-col items-center'>
                        ...
                        <h3 className='text-zinc-950 md:text-white font-bold text-2xl md:text-4xl md:leading-15 w-[210px] md:w-[350px] 2xl:w-[450px]'>Get Closer View & Different Feeling</h3>
                    </div>
                    <div>
