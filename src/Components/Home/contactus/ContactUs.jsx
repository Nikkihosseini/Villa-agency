           ...
           <div className='my-12 md:my-26'>
                ...
                <div className='container mx-auto px-4 xl:px-20'>
                   ...
                   <div className='flex flex-col items-center'>
                    ...
                    <div className='flex items-center justify-between w-full 2xl:gap-x-12'>
                        <div className='h-full w-[60%]'>
                            <div className='h-125 w-full bg-white rounded-[0.8rem] shadow-normal font-bold flex items-center justify-center text-3xl mb-12'>Map</div>
                            <div className='flex items-center justify-between gap-x-10'>
                                <div className='flex items-center text-start w-1/2 gap-x-6 shadow-normal rounded-[0.8rem] p-8 bg-white'>
                                <img src="./public/images/icon/phone-icon.png" alt="phone-icon"/>
                                <div className='flex flex-col'>
                                    <span className='font-bold text-xl'>010-020-0340</span>
                                ...
                                <div className='flex flex-col'>
                                    <span className='font-bold text-xl'>info@villa.co</span>
                                    <span className='text-gray-400'>Business Email</span>
                                </div>
                                </div>
                            </div>
                        </div>
                        <div className='w-[40%] p-6 bg-white rounded-[0.8rem] text-start text-gray-700 shadow-normal'>
                            <form>
                            ...
                            <button className='font-semibold flex items-center justify-center w-[170px] h-[45px] bg-zinc-950 text-white hover:bg-red-500 rounded-full transition-all cursor-pointer' type='submit'>Send Message</button>
                        </div>
                    </div>
                   </div>
                </div>
