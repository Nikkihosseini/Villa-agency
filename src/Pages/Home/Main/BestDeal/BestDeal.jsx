                   ...
                   <div className='py-12 md:py-26 w-full'>
                     <div className='flex flex-col lg:flex-row gap-y-5 lg:gap-y-0 items-center justify-between mb-10 lg:mb-15 xl:mb-20'>
                         ...
                         <div className='flex items-center justify-center gap-x-4 text-white font-semibold flex-wrap sm:flex-nowrap  gap-y-3 sm:gap-y-0 sm:w-[480px]'>
                            ...
                            <button className='bg-zinc-950 rounded-md w-[130px] h-[35px] sm:w-[150px] sm:h-[50px] cursor-pointer tracking-wide text-base sm:text-lg hover:bg-red-500 transition-all'>Villa House</button>
                            <button className='bg-zinc-950 rounded-md w-[130px] h-[35px] sm:w-[150px] sm:h-[50px] cursor-pointer tracking-wide text-base sm:text-lg hover:bg-red-500 transition-all'>Penthouse</button>
                         </div> 
                     </div>
